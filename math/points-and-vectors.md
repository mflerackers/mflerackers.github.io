...
## Points
A two dimensional point, defined as (x, y) describes a position or coordinate in 2D. Points can determine a position of an object or camera. They can define a path or way-points which a character needs to follow. Or they can define the shape of an object as for example the points of a polygon.
...
and all the other points will move away from the origin when the scale factor is greater than 1 or move towards the origin when the scale factor is smaller than 1.
## Vectors
